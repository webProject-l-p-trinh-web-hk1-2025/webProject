...
public class AdminChatController {
    ...
    /**
     * API lấy thống kê tin nhắn chưa đọc
     * GET /admin/api/chat/unread-stats
    ...
    /**
     * API đánh dấu tất cả tin nhắn từ một user là đã đọc
     * POST /admin/api/chat/mark-all-read/{userId}
     */
