...
public class ProductPageController {
    ...
    public String productDetail(@PathVariable Long id, Model model) {
        ...
        if (product.getName() != null && product.getBrand() != null) {
            ...
            for (ProductResponse p : allProducts) {
                if (p.getId().equals(product.getId())) continue; // Skip current product
                if (p.getName() == null || p.getBrand() == null) continue;
     ...
     * Example: "iPhone 15 Pro Max 256GB Titan Đen" → "iPhone 15"
     * Example: "Samsung Galaxy S24 Ultra 512GB" → "Galaxy S24"
     * Example: "Xiaomi 14 Ultra 16GB/512GB" → "Xiaomi 14"
     */
