                            ...
                            <div class="shop-img">
                                <c:choose>
                                    <c:when test="${status.index == 0}">
                                        <img src="${pageContext.request.contextPath}/uploads/products/banersamsung.jpg" alt="${cat.name}" style="width: 100%; height: 300px; object-fit: cover;">
                                    </c:when>
                                    <c:when test="${status.index == 1}">
                                        <img src="${pageContext.request.contextPath}/uploads/products/bannerapple.jpg" alt="${cat.name}" style="width: 100%; height: 300px; object-fit: cover;">
                                    </c:when>
                                    <c:otherwise>
                                        <img src="${pageContext.request.contextPath}/uploads/products/banerxiaomi.jpg" alt="${cat.name}" style="width: 100%; height: 300px; object-fit: cover;">
                                    </c:otherwise>
                                </c:choose>
                            </div>
                            <div class="shop-body">
                                <h3>${cat.name}<br>Collection</h3>
                                <a href="${pageContext.request.contextPath}/shop?category=${cat.id}" class="cta-btn">Xem ngay <i class="fa fa-arrow-circle-right"></i></a>
                            </div>
                        </div>
                    </div>
                    <!-- /shop -->
                ...
                <div class="col-md-12">
                    <div class="row">
                        <div class="products-tabs">
                            <c:forEach items="${categories}" var="cat" varStatus="status">
                                <!-- tab -->
                                <div id="tab-${cat.id}" class="tab-pane <c:if test='${status.first}'>active</c:if>">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="hot-deal">
                        ...
                        <a class="primary-btn cta-btn" href="${pageContext.request.contextPath}/shop">Mua ngay</a>
                    </div>
                </div>
            </div>
            <!-- /row -->
