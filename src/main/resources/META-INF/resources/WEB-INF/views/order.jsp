            ...
            <div class="order-form-section">
                ...
                <form id="orderForm">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-input" id="fullName" name="fullName" placeholder="Nhập họ và tên">
                        <div class="error-message" id="fullNameError"></div>
                    </div>

                    <div class="form-group">
                        <label class="form-label required">Số điện thoại</label>
                        <input type="tel" class="form-input" id="phone" name="phone" placeholder="Nhập số điện thoại">
                        <div class="error-message" id="phoneError"></div>
                    </div>

                    <div class="form-group">
                        <label class="form-label required">Địa chỉ giao hàng</label>
                        <textarea class="form-input" id="address" name="address" placeholder="Số nhà, tên đường, phường/xã, quận/huyện, tỉnh/thành phố"></textarea>
                        <div class="error-message" id="addressError"></div>
                    </div>

                    <div class="form-group">
                        <label class="form-label">Ghi chú</label>
                        <textarea class="form-input" id="notes" name="notes" placeholder="Ghi chú thêm (không bắt buộc)"></textarea>
                    </div>
                </form>
            </div>
