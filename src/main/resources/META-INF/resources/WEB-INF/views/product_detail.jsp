                          ...
                          <h3 class="product-price" id="productPrice">
                            <c:choose>
                              <c:when test="${product.onDeal == true && product.dealPercentage != null && product.dealPercentage > 0}">
                                ...
                                <span style="color: #ff4444; font-size: 16px; margin-left: 10px; font-weight: bold; background: #ffe8e8; padding: 2px 8px; border-radius: 4px;">
                                  -${product.dealPercentage}%
                                </span>
                                <span style="color: #28a745; font-size: 16px; margin-left: 10px; font-weight: bold; background: #e8f5e8; padding: 2px 8px; border-radius: 4px;">
