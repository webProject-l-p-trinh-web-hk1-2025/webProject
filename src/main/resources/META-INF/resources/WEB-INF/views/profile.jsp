                    ...
                    <div>
                        ...
                        <div id="tab-overview" class="tab-content-section active">
                            <div class="card-compact mb-3">
                                <div
                                    ...
                                    <h6
                                        ...
                                        <i class="fa fa-user" style="color:#D10024; margin-right:8px;"></i>Thông tin cá
                                        nhân
                                    </h6>
                            ...
                            <div class="card-compact">
                                <h6
                                    ...
                                    <i class="fa fa-shopping-cart" style="color:#D10024; margin-right:8px;"></i>Đơn hàng
                                    gần đây
                                </h6>
                                <c:choose>
                                    <c:when test="${empty recentOrders}">
                                        <div class="text-muted"
                                            ...
                                            <div style="margin-top:15px; color:#8D99AE; font-size:14px;">Bạn chưa có đơn
                                                hàng nào.</div>
                                        </div>
                                    </c:when>
                                    <c:otherwise>
                        ...
                        <div id="tab-orders" class="tab-content-section">
                            <div class="card-compact">
                                <h6
                                    style="margin:0 0 20px 0; font-size:16px; font-weight:700; color:#2B2D42; border-bottom:2px solid #D10024; padding-bottom:10px; display:inline-block;">
                                    <i class="fa fa-list-alt" style="color:#D10024; margin-right:8px;"></i>Tất cả đơn
                                    hàng
                                </h6>
                                <c:choose>
                                    <c:when test="${empty orders}">
                                        <div class="text-muted"
                                            ...
                                            <div style="margin-top:8px; color:#8D99AE; font-size:14px;">Hãy khám phá các
                        ...
                        <div id="tab-offers" class="tab-content-section">
                            <div class="card-compact">
                                <h6
                                    style="margin:0 0 20px 0; font-size:16px; font-weight:700; color:#2B2D42; border-bottom:2px solid #D10024; padding-bottom:10px; display:inline-block;">
                                    <i class="fa fa-gift" style="color:#D10024; margin-right:8px;"></i>Ưu đãi dành cho
                                    bạn
                                </h6>

                                <div
                                    style="padding:20px; background:linear-gradient(135deg, #FFF5F5 0%, #FFEBEB 100%); border-left:4px solid #D10024; border-radius:3px; margin-bottom:15px;">
                                    <div style="font-size:16px; font-weight:700; color:#D10024; margin-bottom:8px;">
                                        <i class="fa fa-star"></i> Giảm 20% đơn hàng đầu tiên
                                    </div>
                                    <div style="color:#2B2D42; font-size:14px; margin-bottom:10px;">
                                        Áp dụng cho đơn hàng từ 500.000₫. Giảm tối đa 100.000₫
                                    </div>
                                    <div>
                                        <span
                                            style="display:inline-block; background:#D10024; color:white; padding:6px 12px; border-radius:3px; font-weight:600; font-size:13px; letter-spacing:1px;">WELCOME20</span>
                                    </div>
                                    <div style="font-size:12px; color:#8D99AE; margin-top:8px;">
                                        <i class="fa fa-clock-o"></i> Hết hạn: 31/12/2025
                                    </div>
                                </div>
                                ...
                                <div
                                    style="padding:20px; background:linear-gradient(135deg, #FFF5F5 0%, #FFEBEB 100%); border-left:4px solid #D10024; border-radius:3px; margin-bottom:15px;">
                                    <div style="font-size:16px; font-weight:700; color:#D10024; margin-bottom:8px;">
                                        <i class="fa fa-star"></i> Miễn phí vận chuyển
                                    </div>
                                    <div style="color:#2B2D42; font-size:14px; margin-bottom:10px;">
                                        Áp dụng cho đơn hàng từ 300.000₫ trên toàn quốc
                                    </div>
                                    <div>
                                        <span
                                            style="display:inline-block; background:#D10024; color:white; padding:6px 12px; border-radius:3px; font-weight:600; font-size:13px; letter-spacing:1px;">FREESHIP</span>
                                    </div>
                                    <div style="font-size:12px; color:#8D99AE; margin-top:8px;">
                                        <i class="fa fa-clock-o"></i> Hết hạn: 30/11/2025
                                    </div>
                                </div>
                                ...
                                <div
                                    style="padding:20px; background:linear-gradient(135deg, #FFF5F5 0%, #FFEBEB 100%); border-left:4px solid #D10024; border-radius:3px; margin-bottom:15px;">
                                    <div style="font-size:16px; font-weight:700; color:#D10024; margin-bottom:8px;">
                                        <i class="fa fa-star"></i> Giảm 15% cho khách hàng thân thiết
                                    </div>
                                    <div style="color:#2B2D42; font-size:14px; margin-bottom:10px;">
                                        Dành cho khách hàng có từ 3 đơn hàng thành công
                                    </div>
                                    <div>
                                        <span
                                            style="display:inline-block; background:#D10024; color:white; padding:6px 12px; border-radius:3px; font-weight:600; font-size:13px; letter-spacing:1px;">VIP15</span>
                                    </div>
                                    <div style="font-size:12px; color:#8D99AE; margin-top:8px;">
                                        <i class="fa fa-clock-o"></i> Không giới hạn
                                    </div>
                                </div>

                                <div
                                    style="text-align:center; padding:20px; margin-top:20px; background:#FAFAFA; border-radius:3px;">
                                    <i class="fa fa-info-circle" style="color:#D10024;"></i>
                                    Vui lòng nhập mã ưu đãi khi thanh toán để được giảm giá
                                </div>
                            </div>
                        </div>
                        ...
                        <div id="tab-account" class="tab-content-section">
                            <div class="card-compact">
                                <h6
                                    style="margin:0 0 20px 0; font-size:16px; font-weight:700; color:#2B2D42; border-bottom:2px solid #D10024; padding-bottom:10px; display:inline-block;">
                                    <i class="fa fa-edit" style="color:#D10024; margin-right:8px;"></i>Cập nhật thông
                                    tin
                                </h6>
                    ...
                    <div id="verifyEmailModal"
                        ...
                        <div
                            ...
                            <div id="emailVerifyStep1">
                                <p style="color:#666; margin-bottom:20px;">Nhấn nút bên dưới để gửi mã OTP đến email:
                            ...
                            <div id="emailVerifyStep2" style="display:none;">
                                <p style="color:#28a745; margin-bottom:20px;"><i class="fa fa-check"></i> Mã OTP đã được
