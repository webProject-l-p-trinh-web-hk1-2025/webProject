        ...
        <body>
            <div class="container">
                ...
                <div class="card-custom mb-3">
                    ...
                    <p class="text-muted">Bạn đang ở hạng thành viên S-MEM. Tích điểm để nâng hạng và nhận thêm ưu đãi.
                    </p>
                </div>
                ...
                <div class="card-custom">
                    ...
                    <c:forEach var="off" items="${offers}">
                        <div class="border p-2 mb-2">${off.title} - <small class="text-muted">${off.description}</small>
                        </div>
                    </c:forEach>
                </div>
            </div>
