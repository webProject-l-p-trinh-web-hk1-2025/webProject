    ...
    <form id="registerForm" action="${pageContext.request.contextPath}/doregister" method="post">
      ...
      <div style="display:flex; flex-wrap:wrap; gap:20px;">
        <div style="flex:1 1 100%;">
          ...
          <input type="text" class="form-control" name="fullName" placeholder="Nhập họ và tên" required value="${not empty fullName ? fullName : ''}" />
        </div>
      </div>
      ...
      <div style="display:flex; flex-wrap:wrap; gap:20px;">
        <div style="flex:1 1 50%;">
          ...
          <input type="text" class="form-control" name="phone" placeholder="Nhập số điện thoại" required value="${not empty phone ? phone : ''}" />
        </div>
        <div style="flex:1 1 50%;">
          <label class="form-label">Email:</label>
          <input type="email" class="form-control" name="email" placeholder="Nhập email" required value="${not empty email ? email : ''}" />
        </div>
      </div>
