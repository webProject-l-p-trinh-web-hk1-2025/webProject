        ...
        <div class="return-section">
            <div class="container">
                <div class="return-header">
                    ...
                    <p>CellPhoneStore cam kết mang đến trải nghiệm mua sắm tốt nhất với chính sách đổi trả linh hoạt và
                        minh bạch</p>
                </div>
                ...
                <div class="return-container">
                    ...
                    <div class="return-card">
                        ...
                        <div class="return-highlight">
                            <p><i class="fa fa-info-circle"></i> <strong>Lưu ý:</strong> Thời gian đổi trả được tính từ
                    ...
                    <div class="return-card">
                        ...
                        <ul>
                            ...
                            <li>Sản phẩm còn nguyên vẹn, không có dấu hiệu sử dụng (đối với đổi trả nguyên seal)</li>
                        ...
                        <ul>
                            ...
                            <li><strong>Hàng khuyến mãi đặc biệt:</strong> Một số chương trình có điều kiện riêng</li>
                        </ul>
                    </div>
                    ...
                    <div class="return-card">
                        ...
                        <div class="return-highlight">
                            <p><i class="fa fa-clock-o"></i> <strong>Thời gian xử lý:</strong> 3-5 ngày làm việc kể từ
                    ...
                    <div class="return-card">
                        ...
                        <h3>2. Hoàn tiền</h3>
                        <ul>
                            <li><strong>Hoàn tiền 100%:</strong> Đối với sản phẩm lỗi kỹ thuật, sai model/màu sắc</li>
                            <li><strong>Hoàn tiền 90%:</strong> Đối với trường hợp đổi ý (đã kích hoạt sản phẩm)</li>
                        ...
                        <div class="return-highlight">
                            <p><i class="fa fa-gift"></i> <strong>Ưu đãi:</strong> Chọn đổi sang voucher để được thêm 5%
                    ...
                    <div class="return-card">
                        ...
                        <ul>
                            <li><strong>Miễn phí vận chuyển:</strong> Đối với sản phẩm lỗi kỹ thuật, sai model/màu sắc
                            </li>
                            <li><strong>Khách hàng chịu phí:</strong> Đối với trường hợp đổi ý (khoảng 30.000đ -
                                50.000đ)</li>
                            <li><strong>Hỗ trợ 50% phí ship:</strong> Đối với khách hàng VIP (mua từ 3 đơn hàng trở lên)
                            </li>
                        </ul>
