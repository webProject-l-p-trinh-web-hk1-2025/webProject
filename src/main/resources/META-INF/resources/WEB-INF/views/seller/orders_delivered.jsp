                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="seller-orders-container">
                                <h1><i class="fa fa-check-circle"></i> Đơn hàng đã giao thành công</h1>

                                <div class="info-section">
                                    <p style="margin: 0; color: #666;">
                                        <i class="fa fa-info-circle"></i> Danh sách các đơn hàng đã được giao thành công
                                        đến khách hàng.
                                    </p>
                                </div>
                                    ...
                                    <div class="order-card">
                                        ...
                                        <div class="order-info">
                                            ...
                                            <div>
                                                ...
                                                <strong>Ngày Hoàn Thành:</strong> ${order.createdAt}
                                            </div>
                                            ...
                                            <div class="success-badge">
                                                <i class="fa fa-check-circle"></i> Đơn hàng đã được giao thành công
                                            </div>
                                        </div>

                                        <h4
                                            style="margin-top: 15px; color: #333; border-bottom: 2px solid #28a745; padding-bottom: 8px;">
                                            ...
                                            <tbody>
                                                <c:forEach var="item" items="${order.items}">
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <strong style="color: #28a745;">x${item.quantity}</strong>
                                                        </td>
                                                        <td>
                                ...
                                <c:if test="${empty orders}">
                                    <div
                                        ...
                                        <h3 style="color: #666; margin-bottom: 10px;">Chưa có đơn hàng nào đã giao</h3>
                                        <p style="font-size: 16px;">Các đơn hàng đã giao thành công sẽ hiển thị tại
                                            đây.</p>
                                    ...
                                    <div style="text-align: center; margin-top: 30px;">
                                        <div class="store-pagination">
                                            ...
                                            <c:if test="${currentPage > 1}">
                                                <a href="${pageContext.request.contextPath}/seller/orders-delivered?page=${currentPage - 1}&size=${pageSize}"
                                            ...
                                            <c:forEach begin="${currentPage - 2 < 1 ? 1 : currentPage - 2}"
                                                ...
                                                <c:choose>
                                                    ...
                                                    <c:otherwise>
                                                        <a href="${pageContext.request.contextPath}/seller/orders-delivered?page=${pageNum}&size=${pageSize}"
                                ...
                                <c:if test="${not empty orders}">
                                    <div
                                        style="margin-top: 30px; padding: 20px; background: #d4edda; border-left: 4px solid #28a745; border-radius: 8px;">
                                        <h4 style="margin: 0 0 10px 0; color: #155724;">
                                            <i class="fa fa-bar-chart"></i> Tổng quan
                                        </h4>
                                        <p style="margin: 5px 0; color: #155724;">
                                            <i class="fa fa-check-circle" style="color: #28a745;"></i>
                                            Tổng số đơn hàng đã giao: <strong>${totalOrders}</strong>
                                        </p>
                                        <p style="margin: 5px 0; color: #155724;">
                                            <i class="fa fa-file-text-o" style="color: #28a745;"></i>
