                ...
                <div class="shipping-container">
                    ...
                    <div class="shipping-card">
                        ...
                        <div class="shipping-highlight">
                            <p><i class="fa fa-gift"></i> <strong>Miễn phí vận chuyển</strong> cho đơn hàng từ 500.000đ
                                trở lên!</p>
                        </div>
                    </div>
                    ...
                    <div class="shipping-card">
                        ...
                        <div class="shipping-warning">
                            <p><i class="fa fa-info-circle"></i> <strong>Lưu ý:</strong> Phí vận chuyển có thể thay đổi
                    ...
                    <div class="shipping-card">
                        ...
                        <ul>
                            <li><strong>Thời gian:</strong> Giao hàng trong vòng 3-4 giờ kể từ khi đặt hàng thành công
                            </li>
                        ...
                        <div class="shipping-highlight">
                            <p><i class="fa fa-clock-o"></i> <strong>Đặt trước 12:00</strong> để nhận hàng trong buổi
                                chiều cùng ngày!</p>
                        </div>
                    </div>
                    ...
                    <div class="shipping-card">
                        ...
                        <div class="shipping-steps">
                            <div class="shipping-step">
                                ...
                                <p>Sau khi đặt hàng thành công, bạn sẽ nhận email/SMS xác nhận đơn hàng với thông tin
                                    chi tiết.</p>
                            </div>
                            <div class="shipping-step">
                                <h4>Đóng gói sản phẩm</h4>
                                <p>Sản phẩm được kiểm tra kỹ lưỡng và đóng gói cẩn thận, kèm phiếu bảo hành và hóa đơn
                                    VAT.</p>
                            </div>
                            <div class="shipping-step">
                            ...
                            <div class="shipping-step">
                                ...
                                <p>Kiểm tra sản phẩm kỹ lưỡng trước khi nhận hàng. Thanh toán (nếu chọn COD) và ký nhận.
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="shipping-card">
                        ...
                        <ul>
                            <li><strong>Kiểm tra hàng:</strong> Được kiểm tra sản phẩm trước khi thanh toán (đối với
                                COD)</li>
                            <li><strong>Từ chối nhận:</strong> Có quyền từ chối nhận hàng nếu sản phẩm không đúng, hư
                                hỏng hoặc không đúng mô tả</li>
                            <li><strong>Đổi hàng ngay:</strong> Đổi sản phẩm khác ngay tại thời điểm giao hàng nếu phát
                                hiện lỗi</li>
                        ...
                        <ul>
                            ...
                            <li>Giữ lại <strong>hóa đơn VAT và phiếu bảo hành</strong> để sử dụng dịch vụ bảo hành</li>
                            <li>Nếu không nhận được hàng sau thời gian dự kiến, vui lòng liên hệ ngay với chúng tôi</li>
                        </ul>

                        <div class="shipping-warning">
                            <p><i class="fa fa-exclamation-triangle"></i> <strong>Quan trọng:</strong> Sau khi ký nhận
                                và thanh toán, bạn không thể từ chối hoặc đổi trả sản phẩm vì lý do đổi ý. Vui lòng kiểm
                    ...
                    <div class="shipping-card">
                        ...
                        <p>Có, bạn có thể thay đổi địa chỉ giao hàng trong vòng <strong>2 giờ</strong> sau khi đặt hàng.
                        ...
                        <p>Bạn có thể ghi chú thời gian mong muốn khi đặt hàng (ví dụ: giao buổi sáng, buổi chiều...).
                        ...
                        <p>Nếu phát hiện sản phẩm hư hỏng khi nhận hàng, vui lòng <strong>chụp ảnh và từ chối nhận
                                hàng</strong> ngay. Liên hệ với chúng tôi để được đổi sản phẩm mới hoàn toàn miễn phí.
                        </p>

                        <h3>Tôi có thể hẹn giao hàng vào cuối tuần không?</h3>
                        <p>Có, chúng tôi giao hàng tất cả các ngày trong tuần, bao gồm cả thứ 7, Chủ nhật và ngày lễ.
                        </p>
                    </div>
