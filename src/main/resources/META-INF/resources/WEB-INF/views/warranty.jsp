        ...
        <div class="warranty-section">
            <div class="container">
                <div class="warranty-header">
                    ...
                    <p>CellPhoneStore cam kết mang đến dịch vụ bảo hành tốt nhất, đảm bảo quyền lợi khách hàng với sản
                ...
                <div class="warranty-container">
                    ...
                    <div class="warranty-card">
                        ...
                        <p>Tất cả sản phẩm điện thoại tại CellPhoneStore đều được bảo hành chính hãng với các mức thời
                            gian như sau:</p>
                        ...
                        <div class="warranty-highlight">
                            <p><i class="fa fa-info-circle"></i> <strong>Lưu ý:</strong> Thời gian bảo hành được tính từ
                    ...
                    <div class="warranty-card">
                        ...
                        <ul>
                            ...
                            <li><strong>Tự ý sửa chữa:</strong> Máy đã được tháo mở, sửa chữa tại nơi không phải trung
                                tâm bảo hành chính hãng</li>
                            <li><strong>Tem bảo hành bị rách, mờ:</strong> Không thể xác định được thông tin bảo hành
                            </li>
                            <li><strong>Sản phẩm không chính hãng:</strong> Hàng nhái, hàng xách tay không rõ nguồn gốc
                            </li>
                    ...
                    <div class="warranty-card">
                        ...
                        <div class="warranty-steps">
                            <div class="warranty-step">
                                ...
                                <p>Mang sản phẩm lỗi, phiếu bảo hành và hóa đơn đến cửa hàng hoặc trung tâm bảo hành</p>
                            </div>
                            <div class="warranty-step">
                        ...
                        <div class="warranty-highlight">
                            <p><i class="fa fa-clock-o"></i> <strong>Thời gian xử lý:</strong> 7-15 ngày làm việc tùy
                    ...
                    <div class="warranty-card">
                        ...
                        <div class="warranty-highlight">
                            <p><i class="fa fa-info-circle"></i> <strong>Điều kiện đổi mới:</strong> Sản phẩm phải còn
                                nguyên vẹn, đầy đủ phụ kiện, hộp, không có dấu hiệu sử dụng hoặc hư hỏng do người dùng.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="warranty-card">
                        ...
                        <p><i class="fa fa-map-marker"></i> Trường ĐH Sư Phạm Kỹ Thuật - 1 Võ Văn Ngân, Linh Chiểu, Thủ
                            Đức, TP.HCM</p>
                        ...
                        <ul>
                            ...
                            <li><strong>Samsung:</strong> Trung tâm bảo hành Samsung Electronics tại TP.HCM, Hà Nội và
                                các tỉnh</li>
