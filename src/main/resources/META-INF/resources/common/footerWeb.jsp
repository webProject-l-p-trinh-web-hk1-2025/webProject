                    ...
                    <div class="row">
                        <div class="col-md-3 col-xs-6">
                            <div class="footer">
                                ...
                                <p>Cửa hàng điện thoại uy tín, chuyên cung cấp các sản phẩm điện thoại chính hãng với
                                ...
                                <ul class="footer-links">
                                    <li><a href="https://www.google.com/maps/place/Tr%C6%B0%E1%BB%9Dng+%C4%90%E1%BA%A1i+h%E1%BB%8Dc+S%C6%B0+ph%E1%BA%A1m+K%E1%BB%B9+thu%E1%BA%ADt+Th%C3%A0nh+ph%E1%BB%91+H%E1%BB%93+Ch%C3%AD+Minh/@10.8505683,106.7717721,17z/data=!4m6!3m5!1s0x31752763f23816ab:0x282f711441b6916f!8m2!3d10.8506324!4d106.7719131!16s%2Fm%2F02pz17z?entry=ttu&g_ep=EgoyMDI1MTAxNC4wIKXMDSoASAFQAw%3D%3D"
                                            target="_blank"><i class="fa fa-map-marker"></i>Trường ĐH Sư Phạm Kỹ Thuật -
                                            1 Võ Văn Ngân, Linh Chiểu, Thủ Đức, TP.HCM</a></li>
                                    <li><a href="https://zalo.me/0889251007" target="_blank"><i
                                                class="fa fa-phone"></i>+84 889-251-007</a></li>
                                    <li><a href="mailto:kietccc21@gmail.com"><i
                                                class="fa fa-envelope-o"></i>kietccc21@gmail.com</a></li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="col-md-3 col-xs-6">
                            <div class="footer">
                                ...
                                <ul class="footer-links">
                                    ...
                                    <li><a href="${pageContext.request.contextPath}/warranty">Chính sách bảo hành</a>
                                    </li>
                                    <li><a href="${pageContext.request.contextPath}/return">Đổi trả hàng</a></li>
                                    <li><a href="${pageContext.request.contextPath}/payment">Hướng dẫn thanh toán</a>
                                    </li>
                        ...
                        <div class="col-md-3 col-xs-6">
                            <div class="footer">
                                ...
                                <ul class="footer-links">
                                    <li><a href="${pageContext.request.contextPath}/profile">Thông tin tài khoản</a>
                                    </li>
                                    <li><a href="${pageContext.request.contextPath}/cart">Giỏ hàng</a></li>
                                    <li><a href="${pageContext.request.contextPath}/wishlist">Yêu thích</a></li>
                                    <li><a href="${pageContext.request.contextPath}/profile#orders">Đơn hàng của tôi</a>
                                    </li>
                                    <li><a href="${pageContext.request.contextPath}/user/chat">Trợ giúp</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
        ...
        <%@ page import="org.springframework.security.core.context.SecurityContextHolder" %>
            <%@ page import="org.springframework.security.core.Authentication" %>
                <%@ page import="org.springframework.security.authentication.AnonymousAuthenticationToken" %>
                    <% Authentication floatingAuth=SecurityContextHolder.getContext().getAuthentication(); boolean
                        isFloatingAuthenticated=floatingAuth !=null && floatingAuth.isAuthenticated() && !(floatingAuth
                        instanceof AnonymousAuthenticationToken); request.setAttribute("isFloatingAuthenticated",
                        isFloatingAuthenticated); %>

                        <c:if test="${isFloatingAuthenticated}">
                            <div class="floating-contact-btn" id="floatingContactBtn">
                                <a href="${pageContext.request.contextPath}/user/chat" class="chat-btn-link">
