...
<%
    Authentication floatingAuth = SecurityContextHolder.getContext().getAuthentication();
    boolean isFloatingAuthenticated = floatingAuth != null && floatingAuth.isAuthenticated() && !(floatingAuth instanceof AnonymousAuthenticationToken);
